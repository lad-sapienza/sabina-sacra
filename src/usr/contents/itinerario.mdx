  ...
  <div className="container mb-5">
    <ul className="nav nav-pills nav-justified mb-4" id="itinerarioTabs" role="tablist">
      <li className="nav-item" role="presentation">
        <button className="nav-link active fs-5 py-3" id="mappa-tab" data-bs-toggle="tab" data-bs-target="#mappa" type="button" role="tab">
          Mappa
          <small className="d-block mt-1 fw-normal text-muted">Visualizza il percorso geografico</small>
        </button>
      </li>
      <li className="nav-item" role="presentation">
    ...
    <div className="tab-content" id="itinerarioTabsContent">
      {/* Tab Mappa con Descrizione integrata */}
      <div className="tab-pane fade show active" id="mappa" role="tabpanel">
            ...
            <Field name={["luoghi_dell_itinerario"]} transformer={ldi => {
              ...
              return (
                <>
                  ...
                  {/* Sezione Descrizione con dashboard */}
