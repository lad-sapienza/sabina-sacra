    ...
    <div className="bg-light p-4 rounded-3 mb-4 shadow-sm">
      ...
      <Accordion className="mt-3">
        <Accordion.Item eventKey="0">
          ...
          <Accordion.Body>
            <p>
              La tabella è ordinabile per nome, località, tipologia e periodo. Clicca sull'intestazione di colonna 
              per cambiare l'ordinamento. Per visualizzare i dettagli completi di ciascun monumento, clicca sul suo nome.
            </p>
            <p className="mb-0">
