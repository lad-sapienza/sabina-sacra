    ...
    <DataTb
      ...
      source={{
        directus: {
          ...
          queryString:
            "filter[tipologia][_eq]=monumento&filter[project_group][_eq]=SARAS&fields=id,nome_luogo,tipo_monumento,anno_inizio,periodo_fine,caratteristica_di_dettaglio,link_immagine,fa_parte_di.nome_luogo,fa_parte_di.toponimo,fa_parte_di.localita&limit=-1"
        }
      }}
      striped
      highlightOnHover
