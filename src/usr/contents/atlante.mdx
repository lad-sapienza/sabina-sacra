  ...
  <VectorLayerLibre
    ...
    source={{
      directus: {
        ...
        geoField: "coordinate",
        queryString:
          "filter[tipologia][_eq]=monumento&filter[project_group][_eq]=SARAS&fields=id,tipo_monumento,nome_luogo,coordinate&limit=-1",
        transType: "geojson",
      }
    }}
    checked={true}
  ...
  <VectorLayerLibre
    ...
    source={{
      directus: {
        ...
        geoField: "coordinate",
        queryString:
          "filter[tipologia][_eq]=luogo&filter[project_group][_eq]=SARAS&fields=id,nome_luogo,,project_group,coordinate&limit=-1",
        transType: "geojson",
      }
    }}
    checked={true}
