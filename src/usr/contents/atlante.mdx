...
<div className="text-end text-secondary">Clicca sul selettore layer<br />per filtrare i monumenti in base<br />ai criteri stabiliti 👇</div>
<div className="position-relative" >
  ...
  >
    <VectorLayerLibre
      ...
      popupTemplate="<h4>${nome_luogo}</h4><p>${tipo_monumento}</p><a href='/monumento/?tb=luogo_di_interesse&id=${id}'>Dettagli</a>"
    />
  </MapLibre>
